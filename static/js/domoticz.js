...
function ShowSmartLog(contentdiv, id, name, switchtype, period) {
	...
	requestAPI("/api?type=command&param=getcosts&idx=" + $.devIdx).then(jsonData => {
			data = jsonData;
...
if (period == "day") {
	...
	$.DayChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
 					requestAPI("/api?type=command&param=graph&sensor=counter&idx=" + id + "&range=day").then(jsonData => {
						data = jsonData;
	...
	$.WeekChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					requestAPI("/api?type=command&param=graph&sensor=counter&idx=" + id + "&range=week").then(jsonData => {
						data = jsonData;
						if (typeof data.result != 'undefined') {
	...
	$.MonthChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					requestAPI("/api?type=command&param=graph&sensor=counter&idx=" + id + "&range=month").then(jsonData => {
						data = jsonData;
						if (typeof data.result != 'undefined') {
	...
	$.YearChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					requestAPI("/api?type=command&param=graph&sensor=counter&idx=" + id + "&range=year").then(jsonData => {
						data = jsonData;
						if (typeof data.result != 'undefined') {
...
if (period == "day") {
	...
	$.LogChart1.highcharts({
		chart: {
			...
			events: {
				load: function () {
					requestAPI("/api?type=command&param=graph&sensor=" + graphtype + "&idx=" + id + "&range=day").then(jsonData => {
						data = jsonData;
						if (typeof data.result != 'undefined') {
							var datatable = [];
	...
	$.LogChart2.highcharts({
		chart: {
			...
			events: {
				load: function () {
					requestAPI("/api?type=command&param=graph&sensor=" + graphtype + "&idx=" + id + "&range=month").then(jsonData => {
						data = jsonData;
						if (typeof data.result != 'undefined') {
							var datatable1 = [];
							var datatable2 = [];
		...
		chart: {
			...
			events: {
				load: function () {
					...
					requestAPI("/api?type=command&param=graph&sensor=" + graphtype + "&idx=" + id + "&range=year").then(jsonData => {
						data = jsonData;
						if (typeof data.result != 'undefined') {
							var datatable1 = [];
							var datatable2 = [];
  ...
  if (period == "day") {
	$.DayChart_Percentage.highcharts({
		chart: {
			...
			events: {
				load: function () {
					requestAPI("/api?type=command&param=graph&sensor=Percentage&idx=" + id + "&range=day").then(jsonData => {
						data = jsonData;
						if (typeof data.result != 'undefined') {
	...
	$.MonthChart_Percentage.highcharts({
		chart: {
			...
			events: {
				load: function () {
					requestAPI("/api?type=command&param=graph&sensor=Percentage&idx=" + id + "&range=month").then(jsonData => {
						data = jsonData;
						if (typeof data.result != 'undefined') {
							var datatable1 = [];
							var datatable2 = [];
	...
	$.YearChart_Percentage.highcharts({
		chart: {
			...
			events: {
				load: function () {
					requestAPI("/api?type=command&param=graph&sensor=Percentage&idx=" + id + "&range=year").then(jsonData => {
						data = jsonData;
						if (typeof data.result != 'undefined') {
							var datatable1 = [];
							var datatable2 = [];
...
if (period == "day") {
		...
		chart: {
			...
			events: {
				load: function () {
					...
					requestAPI("/api?type=command&param=graph&sensor=temp&idx=" + id + "&range=day").then(jsonData => {
						data = jsonData;
						if (typeof data.result != 'undefined') {
	...
	$.MonthChart_Temp.highcharts({
		chart: {
			...
			events: {
				load: function () {
					requestAPI("/api?type=command&param=graph&sensor=temp&idx=" + id + "&range=month").then(jsonData => {
						data = jsonData;
						if (typeof data.result != 'undefined') {
	...
	$.YearChart_Temp.highcharts({
		chart: {
			...
			events: {
				load: function () {
					requestAPI("/api?type=command&param=graph&sensor=temp&idx=" + id + "&range=year").then(jsonData => {
						data = jsonData;
						if (typeof data.result != 'undefined') {
